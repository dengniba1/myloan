...
public class RSAUtils {
	...
	protected static final Provider pro = new BouncyCastleProvider();
	/** 种子,改变后,生成的密钥对会发生变化 */
	private static final String seedKey = "greenwich";
	...
	public static byte[] encrypt(String input){
		try {
			...
			LOGGER.info("encrypt use time " + (end - start) + "");
			return re;
		} catch (Exception e) {
			e.printStackTrace();
			throw new RuntimeException();
	...
	public static String encryptToString(String input){
		return Hex.toHexString(encrypt(input));
	}

	public static String decryptToString(String input){
		try {
			return new String((RSAUtils.decrypt(Hex.decode(input))),charSet);
	...
	public static void main(String[] args) throws Exception {
		String encryptString = encryptToString("你好");
		System.out.println(encryptString);
		String decryptString = decryptToString(encryptString);
